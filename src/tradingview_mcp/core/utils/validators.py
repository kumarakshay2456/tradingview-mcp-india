...
STOCK_EXCHANGES: Set[str] = {"egx", "bist", "nasdaq", "nyse", "bursa", "myx", "klse", "ace", "leap", "hkex", "hk", "hsi", "asx", "sse", "szse", "chn", "nse", "bse"}
...
EXCHANGE_SCREENER = {
    ...
    # India Stock Market Support
    "nse": "india",         # National Stock Exchange of India
    "bse": "india",         # Bombay Stock Exchange (BSE)
}
